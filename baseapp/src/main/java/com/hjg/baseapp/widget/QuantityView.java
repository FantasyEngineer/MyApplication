...
/**
 * @author hjg
 * @data 2017-8-21 11:04:22
 * @title 购物车购买数量的增加和减少控件（仿淘宝外卖）
 */
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    private int addButtonWidth, addButtonHeight, subButtonWidth, subButtonHeight;
...
//        quantityBackground = ContextCompat.getDrawable(getContext(), R.drawable.qv_bg_selector);
        ...
        addButtonHeight = (int) a.getDimension(R.styleable.QuantityView_addButtonHeight, pxFromDp(24));
        addButtonWidth = (int) a.getDimension(R.styleable.QuantityView_addButtonWidth, pxFromDp(24));
        subButtonHeight = (int) a.getDimension(R.styleable.QuantityView_subButtonHeight, pxFromDp(24));
        subButtonWidth = (int) a.getDimension(R.styleable.QuantityView_subButtonWidth, pxFromDp(24));
        ...
        mButtonAdd.setWidth(addButtonWidth);
        mButtonAdd.setHeight(addButtonHeight);
        ...
        mButtonRemove.setWidth(subButtonWidth);
        mButtonRemove.setHeight(subButtonHeight);
    ...
    public void onClick(View v) {
        ...
        } else if (v == mTextViewQuantity) {//不需要弹出弹出框让用户输入
