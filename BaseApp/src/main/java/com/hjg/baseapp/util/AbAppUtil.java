...
public class AbAppUtil {
    ...
    public static void installApk(Context context, File file) {
        ...
        Log.e("path", FileProvider.getUriForFile(context, "com.xizhi.mezone.b" + ".fileprovider", file).getPath());
        Intent intent = new Intent(Intent.ACTION_VIEW);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
            intent.setDataAndType(FileProvider.getUriForFile(context, "com.xizhi.mezone.b" + ".fileprovider", file), "application/vnd.android.package-archive");
        else
