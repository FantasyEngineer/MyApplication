package com.hjg.baseapp.widget.zoomview;
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (mZoomView != null && !isHideHeader() && isPullToZoomEnabled()) {
                    ...
                    if (onScrollValueListener != null) {
                        onScrollValueListener.onValue(f);
                    }
                    if (isParallax()) {
...
//        rv.setId(android.R.id.list);
    ...
    public OnScrollValueListener getOnScrollValueListener() {
        return onScrollValueListener;
    }
