 ...
 * app:isTabIndicator_fill="false" 下划线是否fill  如果设置false  必须传tabWidth/>
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean isIndicatorFill = false;
    ...
    public void setIndicatorFill(boolean indicatorFill) {
        isIndicatorFill = indicatorFill;
    }
...
//        tabTextSize = a.getDimensionPixelSize(0, tabTextSize);
        ...
        isIndicatorFill = a.getBoolean(R.styleable.PagerSlidingTabStrip_isTabIndicator_fill, true);
    ...
    private void addTab(final int position, final View tab) {
        ...
        tab.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                if (tabWidth == 0) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isIndicatorFill) {
            if (currentTab instanceof TextView) {
                ...
                padding = (int) textView.getPaint().measureText("你好");//模拟文字宽度  这里是固定的两个字
                padding = (tabWidth - padding) / 2;
            }
        }
//        canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height, rectPaint);
        canvas.drawRect(padding == 0 ? lineLeft : lineLeft + padding, height - indicatorHeight, padding == 0 ? lineRight : lineRight - padding, height, rectPaint);
        // draw divider
